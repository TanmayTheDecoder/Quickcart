...
const DesktopFilters: React.FC<DesktopFiltersProps> = ({ handleFilters }) => {
	return (
		<>
					...
					<div>
						...
						>
							...
							<a
								href='#'
								aria-current='page'
								className='relative z-10 inline-flex items-center bg-[#01997c] px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2'
							>
								1
							</a>
							<a
